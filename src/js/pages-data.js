export const PagesData = [
    // PAGE SLIDE 1 -- More with less
    {
        ...
        introVideo: 'https://s3-eu-west-1.amazonaws.com/mis-implants/makeitsimple/Minisite/MIS_V3_vimeo.mp4',
        introMobileVideo: 'https://s3-eu-west-1.amazonaws.com/mis-implants/makeitsimple/Minisite/MIS_V3_mobile.mp4',
        infoblock: {
            title: {
                tag: 'h1',
                txt: 'More with less'
    ...
    // PAGE SLIDE 6 -- Technology taken to the limits
    {
        ...
        introVideo: 'https://s3-eu-west-1.amazonaws.com/mis-implants/makeitsimple/Minisite/mis_mguide_desktop.mp4', 
        infoblock: {
            title: {
                tag: 'h1',
                txt: 'Technology taken to the limits'
            },
            txt: 'Pushing the envelope of today\'s technological advancements in guided implantology, means MIS continuously explores new ways in which technology can take digital implant dentistry to the next level for optimal results.',
            group: {
                type: 'numbers',
                items: [
                    {
                        title: 1,
                        text: 'One source for the entire digital implant placement procedure. From scan to smile.'
                    },
                    {
                        title: 3,
                        text: 'MSOFT, MGUIDE and MLAB. Three powerful tools and services under one MCENTER roof, to make the process simple.'
                    },
                    {
                        title: 24,
                        text: '24 hour global customer service to ensure that scanning, planning and placement go as smoothly and accurately as possible.'
                    },
                    {
                        title: 3,
        ...
        outblock: {
            txt: 'The key is to use the most advanced, sophisticated technology, like MIS MGUIDE, so that our customers see simple, convenient results.',
            h2: 'Using MIS digital dentistry tools to make things simpler.',
            btn: {
                link: 'http://www.mis-implants.com/MIS-Info/ContactUs.aspx',
                txt: 'Contact your local distributor'
            }
