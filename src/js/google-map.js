...
function addMarkerWithTimeout(country, timeout) {
    window.setTimeout(function() {
        ...
        markers.push(
            new google.maps.Marker(marker_data).addListener('click', function() {
